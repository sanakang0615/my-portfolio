                      ...
                      <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:`opacity-100 transition-opacity duration-300 flex items-center justify-center">
                        <div className="flex items-center gap-4 ">
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="p-3 bg-green-500 text-white rounded-full hover:`bg-green-600 transition-colors w-12 h-12 flex items-center justify-center"
                          >
                          ...
                          {drawing.appleMusicLink && (
                            ...
                            >
                              <Image src="/apple_music_logo.png" alt="Apple Music" width={20} height={20} style={{ borderRadius: '5px' }} />
                            </a>
                          )}
                          {drawing.youtubeLink && (
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="p-3 bg-red-500 text-white rounded-full hover:`bg-red-600 transition-colors w-12 h-12 flex items-center justify-center"
                            >
